...
{
    public class DisplaySPR1Controller : Controller
    {

        private DtClsDB_AIADataContext db;
        private string controller_name = "DisplaySPR1";
        private string title_name = "DisplaySPR1";


        // GET: DisplaySPR1
        public DisplaySPR1Controller()
        {
